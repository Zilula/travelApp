...
class Articles extends React.Component {
  ...
  renderList = () => {
      return mocks.map(place => {
          return<Text style={{ fontSize: theme.sizes.font * 1.2, margin: theme.margin.sm }}  onPress={() => this.props.navigation.navigate('Place', {place: place})}  >{place.location}</Text>
      })
  }
  ...
  render() {
    return (
      ...
      >
          <Text style={{ fontSize: theme.sizes.font * 1.4, margin: theme.sizes.margin}}>Recommended</Text>
